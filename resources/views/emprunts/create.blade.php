...
<body>
    ...
    <form action="{{ route('emprunts.store') }}" method="POST">
        ...
        <input type="text" id="IdAbonne" name="IdAbonne"><br>

        <label for="DateEmprunt">Date Emprunt:</label><br>
        <input type="Date" id="DateEmprunt" name="DateEmprunt"><br>

        <label for="DateRetourPrevue">Date Retour Prevue:</label><br>
        <input type="Date" id="DateRetourPrevue" name="DateRetourPrevue"><br>

        <label for="DateRetourReelle">DateRetourReelle:</label><br>
        <input type="Date" id="DateRetourReelle" name="DateRetourReelle"><br>
